...
public class SimplexNoise {  // Simplex noise in 2D, 3D and 4D
    ...
    public float[][][] create3D(int size, final float wavelength, final float amplitude) {
        return create3D(size, wavelength, -amplitude, amplitude);
    }

    public float[][][] create3D(int size, final float wavelength, final float min, final float max) {
        ...
        for (int x = 0; x < size; x++) {
            ...
            for (int y = 0; y < size; y++) {
                ...
                for (int z = 0; z < size; z++) {
                    ...
                    map[x][y][z] = (float) ((noise(1f + fx, 1f + fy, 1f + fz) + 1f) * 0.5f * range) + min;
                }
            }
        }
    ...
    public float[][][][] create4D(int size, final float wavelength, final float amplitude) {
        return create4D(size, wavelength, -amplitude, amplitude);
    }

    public float[][][][] create4D(int size, final float wavelength, final float min, final float max) {
        float[][][][] map = new float[size][size][size][size];
            ...
            for (int y = 0; y < size; y++) {
                ...
                for (int z = 0; z < size; z++) {
                    ...
                    for (int w = 0; w < size; w++) {
                        ...
                        map[x][y][z][w] = (float) (((noise(1f + fx, 1f + fy, 1f + fz, 1f + fw) + 1f) * 0.5f * range) + min);
                    }
                }
            }
        }
